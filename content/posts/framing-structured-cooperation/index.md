...
stack traces that span multiple services, and what amounts to stack unwinding, again across multiple services. However,
it doesn't force you into anything---you're always free to only apply structured cooperation to those things that need
to be synchronized, while not using it (or [launching an independent
